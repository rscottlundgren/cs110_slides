...
Using the power method we can obtain the probability $P^2_{ij}$ that the random surfer will move from page $i$ to page $j$ in two moves by multiplying the transition matrix $P$ by itself $$P^2_{ij} = P_{i:} \cdot P_{:j}$$ 
