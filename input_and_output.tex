...
\end{minipage}%
\begin{minipage}{150pt}
\hfill \visible<4->{\includegraphics[scale=0.18]{figures/usa.png}}
\end{minipage}
\end{frame}
...
\end{minipage}%
\begin{minipage}{150pt}
\hfill \visible<3->{\includegraphics[scale=0.13]{figures/bouncing_ball.png}}
\end{minipage}
\end{frame}
...
\end{minipage}%
\begin{minipage}{150pt}
\hfill \visible<4->{\href{run:elise.wav}{\includegraphics[scale=0.2]{figures/speaker.png}}}
\end{minipage}
\end{frame}
\end{document}
