...
Analogously, 603 in base 10 means $603 = 6 \cdot 10^2 + 0 \cdot 10^1 + 3 \cdot 10^0$ and 207 in base 8 means $207 = 2 \cdot 8^2 + 0 \cdot 8^1 + 7 \cdot 8^0$
...
\begin{center}
\visible<2->{\includegraphics[scale=0.22]{figures/em_switch.png}}
\end{center}
...
\begin{center}
\visible<3->{\includegraphics[scale=0.22]{figures/and_gate.png}\hspace{1cm} \includegraphics[scale=0.22]{figures/or_gate.png}}
\end{center}
...
\begin{center}
\visible<3->{\includegraphics[scale=0.3]{figures/gate_symbols.png}}
\end{center}
...
\begin{center}
\visible<4->{\includegraphics[scale=0.22]{figures/implication_circuit.png}}
\end{center}
\end{frame}
...
\begin{center}
\visible<4->{\includegraphics[scale=0.4]{figures/ripple_carry_adder.png}}
\end{center}
\end{frame}
...
\begin{center}
\visible<5->{\includegraphics[scale=0.4]{figures/latch.png}}
\end{center}
...
\begin{center}
\visible<2->{\includegraphics[scale=0.35]{figures/von_neumann_arch.png}}
\end{center}
\end{frame}
\end{document}
